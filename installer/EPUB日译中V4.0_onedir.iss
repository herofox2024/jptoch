...
#define MyAppSourceDir "..\dist\AI日译中(EPUB)V" + MyAppVersion + "_onedir"
...
OutputBaseFilename=AI日译中(EPUB)V{#MyAppVersion} 目录版安装程序
...
[Run]
Filename: "{app}\{#MyAppExeName}"; Description: "启动 {#MyAppName}"; Flags: nowait postinstall skipilsilent
